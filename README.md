# The Minimal Light Theme for Project Pages

[![LICENSE](https://img.shields.io/github/license/yaoyao-liu/minimal-light-project-pages?style=flat-square&logo=creative-commons&color=EF9421)](https://github.com/yaoyao-liu/minimal-light-project-pages/blob/main/LICENSE)
...
```yaml
remote_theme: yaoyao-liu/minimal-light-project-pages
```
